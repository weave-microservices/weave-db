...
describe('NEW db-service CRUD methods', () => {
  ...
  broker.createService({
    ...
    adapter: MongoDbAdapter({
      url: 'mongodb://localhost:27017/weave-db-test'
    }),
  ...
  it('should insert multiple docs', () => {
    const docsWithoutId = (dd) => dd.map(doc => {
      delete doc._id
      return doc
    })
    return broker.call('test.insertMany', { entities: docsWithoutId([docs[1], docs[3], docs[2]]) })
      .then(results => {
